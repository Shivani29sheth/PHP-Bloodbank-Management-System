...
<body>
			...
			<div id="body">
				...
				?>
					...
					<span style="color: white; font-size: 45px; text-align: center; margin-right: 30px; margin-top: 40px;">List of Blood Groups in-stock</span>
					...
					while($r1=$q->fetch(PDO::FETCH_OBJ))
						{
							...
							<tr>
								...
								<td><font color="#808000"><center><?= $r1->quantity;?></center></td>
